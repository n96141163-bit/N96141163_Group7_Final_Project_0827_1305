...
class InitMenu:
    ...
    def draw(self, surface):
        ...
        self.draw_text(surface,"按 P 開 始 送 餐", 28, BLACK, True, SCREEN_WIDTH/2, 350)
        self.draw_text(surface,"按 住 I 查 看 說 明", 28, BLACK, True, SCREEN_WIDTH/2, 400)
        ...
        if keys[pygame.K_i]:
            ...
            #self.draw_text(surface, f"撞 擊 車 輛 或 路 人 : 生 命 值↓ 交 保 金 額↑", 28, BLACK, False, SCREEN_WIDTH/2, SCREEN_HEIGHT/2+10)
