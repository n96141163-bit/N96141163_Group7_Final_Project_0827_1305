...
class GameView:
    ...
    def draw(self, model, surface):
            ...
            if model.is_pass:
                ...
                if keys[pygame.K_n]:
                    ...
                    if Glo.EXCEEDSPEED == True:
                        ...
                        surface.blit(pygame.transform.scale(pygame.image.load("Image/spaceship.png"),(325, 400)), (162.5, 400))
        ...
        self.draw_text(surface, f"訂 單 {model.user.level}", 20, WHITE, False, SCREEN_WIDTH-65, 0)
        
        self.draw_text(surface, f"  剩 餘 距 離  ", 20, WHITE, False, 100, SCREEN_HEIGHT-170)
        ...
        self.draw_text(surface, f"  花 費 時 間  ", 20, WHITE, False, 100, SCREEN_HEIGHT-130)
        self.draw_text(surface, f"{int(Glo.TIMER/1000)} 秒", 20, WHITE, False, 100, SCREEN_HEIGHT-110)
        
        self.draw_text(surface, f"  油 門 時 速  ", 20, WHITE, False, 100, SCREEN_HEIGHT-90)
        self.draw_text(surface, f"{int(Glo.SPEED_RATE*50)} km/hr", 20, WHITE, False, 100, SCREEN_HEIGHT-70)
 
        self.draw_text(surface, "預 估 交 保 金 額", 20, WHITE, False, 100, SCREEN_HEIGHT-50)
